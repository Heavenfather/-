...
public static class Log
{
    ...
    static Log()
    {
        ...
        //日志文件路径
        IConfigManager configMgr = new ConfigManagerByJson(SysDefine.SYS_PATH_SYSCONFIGINFO);
        ...
        {
            _LogPath = UnityEngine.Application.streamingAssetsPath + "//" + JSON_CONFIG_LOG_DEFAULT_PATH;
        }
